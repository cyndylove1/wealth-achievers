...
const Button: React.FC<CustomButtonProps> = ({
  ...
  return (
    <motion.button
      ...
      className={`${bgColor} px-8 py-2 font-bold rounded-lg flex items-center justify-between gap-4 shadow-lg transition-colors duration-600 ease-in-out hover:shadow-xl justify-center ${className}`}
    >
